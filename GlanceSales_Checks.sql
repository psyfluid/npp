...
SELECT TOP 100
       ...
       CASE
           WHEN SUM(_Document86_VT1448._Fld1455) = 0
           THEN 0
           ELSE CAST(CAST(100 AS NUMERIC(3, 0)) - CAST(CAST(100 AS NUMERIC(3, 0)) AS NUMERIC(11, 8)) * CAST(SUM(_Document86_VT1448._Fld1456) AS NUMERIC(21, 2)) / CAST(SUM(_Document86_VT1448._Fld1454 * _Document86_VT1448._Fld1455) AS NUMERIC(21, 2)) AS NUMERIC(3, 0))
       END AS DiscountPercent,
       CAST(SUM(_Document86_VT1448._Fld1456) AS NUMERIC(21, 2)) AS SumTotal
--INTO
--     #Sales
FROM
