...
(
    ...
    FROM
         tempdb..sysobjects
    WHERE  id = OBJECT_ID('tempdb..#Sales')
           AND xtype = 'U'
)
    DROP TABLE #Sales;
GO
...
(
    ...
    FROM
         tempdb..sysobjects
    WHERE  id = OBJECT_ID('tempdb..#SalesPriceDates')
           AND xtype = 'U'
)
...
(
    ...
    FROM
         tempdb..sysobjects
    WHERE  id = OBJECT_ID('tempdb..#Rests')
           AND xtype = 'U'
)
    DROP TABLE #Rests;
GO
...
(
    ...
    FROM
         tempdb..sysobjects
    WHERE  id = OBJECT_ID('tempdb..#SalesRests')
           AND xtype = 'U'
)
...
(
    ...
    FROM
         tempdb..sysobjects
    WHERE  id = OBJECT_ID('tempdb..#ReceiptDates')
           AND xtype = 'U'
)
...
WHERE  _AccumReg2245._Active = 0x01
...
SELECT
       ...
       'http://apps-srv-1:8383/fotobank/servlet/'+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 29, 8)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 24, 5)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 19, 5)+'-'+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 7, 2)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 5, 2)+'-'+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 3, 2)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 1, 2)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 12, 2)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 10, 2)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 17, 2)+SUBSTRING(CAST(CONVERT(UNIQUEIDENTIFIER, #SalesRests.goodsRef) AS VARCHAR(36)), 15, 2) AS ITEM_IMAGE,
